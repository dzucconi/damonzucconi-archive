...
const PRACTICE_STATEMENTS = [
  ...
  "Language figures in his work as a material, with weight and behavior apart from what it says.",
  "Much of his work begins with accumulation—images, words, lists, websites—reorganized through systems of his own design.",
  "His work frames perception as a feedback loop between the viewer, the image, and the apparatus that produced both.",
  "Randomness enters his work as formalized potential: every decision and none, simultaneously.",
  "His recent work extends these concerns into moving image, synthetic voice, and AI-generated imagery, using loops and captions to unsettle narrative expectation.",
  "He treats recognition as a bodily event, from word shape and typographic disruption to optical ambiguity.",
  "Subtraction recurs as a method in his work, removing one register of a familiar system so that another mode of perception can surface.",
  "His work continually attempts to occupy the gap between language and sensation.",
  "His work makes its computational processes visible without relying on technological novelty.",
  "His work returns repeatedly to the act of looking itself—its distances, its orientation, its grounding in the body.",
  "Time runs through his work as a material, in loops, counters, clocks, and questions of state.",
