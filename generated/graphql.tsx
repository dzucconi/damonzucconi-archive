...
/** Autogenerated input type of AbortMultipartUploadMutation */
export type AbortMultipartUploadMutationInput = {
...
/** Autogenerated return type of AbortMultipartUploadMutation. */
export type AbortMultipartUploadMutationPayload = {
  __typename?: 'AbortMultipartUploadMutationPayload';
...
/** Autogenerated input type of AddArtworkToExhibitionMutation */
export type AddArtworkToExhibitionMutationInput = {
  artwork_id: Scalars['ID'];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  exhibition_id: Scalars['ID'];
};

/** Autogenerated return type of AddArtworkToExhibitionMutation. */
export type AddArtworkToExhibitionMutationPayload = {
  __typename?: 'AddArtworkToExhibitionMutationPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
...
/** Autogenerated input type of AddPersonMutation */
export type AddPersonMutationInput = {
  attributes: PersonAttributes;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
};

/** Autogenerated return type of AddPersonMutation. */
export type AddPersonMutationPayload = {
  __typename?: 'AddPersonMutationPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  person: Person;
};

/** Autogenerated input type of AddPersonToExhibitionMutation */
export type AddPersonToExhibitionMutationInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  exhibition_id: Scalars['ID'];
...
/** Autogenerated return type of AddPersonToExhibitionMutation. */
export type AddPersonToExhibitionMutationPayload = {
  __typename?: 'AddPersonToExhibitionMutationPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  exhibition: Exhibition;
};
...
export type Artwork = {
  ...
  price?: Maybe<Price>;
  production_files: Array<ProductionFile>;
  slug: Scalars['String'];
...
/** An artwork */
export type ArtworkExhibitionsArgs = {
...
/** An artwork */
export type ArtworkProduction_FilesArgs = {
  state?: InputMaybe<Array<State>>;
};
...
export type ArtworkEntityAttributes = {
  ...
  production_file?: InputMaybe<ProductionFileAttributes>;
};
...
/** Autogenerated input type of CompleteMultipartUploadMutation */
export type CompleteMultipartUploadMutationInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  file_key: Scalars['String'];
  parts: Array<MultipartUploadPartAttributes>;
  upload_id: Scalars['String'];
};

/** Autogenerated return type of CompleteMultipartUploadMutation. */
export type CompleteMultipartUploadMutationPayload = {
  __typename?: 'CompleteMultipartUploadMutationPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The public URL of the completed upload */
  url: Scalars['String'];
};

/** Autogenerated input type of CreateMultipartUploadMutation */
export type CreateMultipartUploadMutationInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  file_content_length: Scalars['BigInt'];
  file_key: Scalars['String'];
  file_type: Scalars['String'];
};

/** Autogenerated return type of CreateMultipartUploadMutation. */
export type CreateMultipartUploadMutationPayload = {
  __typename?: 'CreateMultipartUploadMutationPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
...
/** Autogenerated input type of DeletePersonMutation */
...
/** Autogenerated return type of DeletePersonMutation. */
...
/** An exhibition */
export type ExhibitionArtworksArgs = {
  state?: InputMaybe<Array<InputMaybe<State>>>;
};
...
/** A pending S3 multipart upload with presigned URLs for each part */
export type MultipartUpload = {
  __typename?: 'MultipartUpload';
  key: Scalars['String'];
  /** Size in bytes of each part (the final part may be smaller) */
  part_size: Scalars['BigInt'];
  /** One presigned URL per part, in part-number order */
  presigned_part_urls: Array<Scalars['String']>;
  upload_id: Scalars['String'];
};

export type MultipartUploadPartAttributes = {
  /** The ETag returned by S3 for the uploaded part */
  etag: Scalars['String'];
...
export type Mutation = {
  __typename?: 'Mutation';
  abort_multipart_upload?: Maybe<AbortMultipartUploadMutationPayload>;
  add_artwork?: Maybe<AddArtworkMutationPayload>;
  add_artwork_entity?: Maybe<AddArtworkEntityMutationPayload>;
  add_artwork_to_exhibition?: Maybe<AddArtworkToExhibitionMutationPayload>;
  ...
  add_person?: Maybe<AddPersonMutationPayload>;
  add_person_to_exhibition?: Maybe<AddPersonToExhibitionMutationPayload>;
  add_tag?: Maybe<AddTagMutationPayload>;
  complete_multipart_upload?: Maybe<CompleteMultipartUploadMutationPayload>;
  create_multipart_upload?: Maybe<CreateMultipartUploadMutationPayload>;
  delete_artwork?: Maybe<DeleteArtworkMutationPayload>;
  delete_exhibition?: Maybe<DeleteExhibitionMutationPayload>;
  delete_person?: Maybe<DeletePersonMutationPayload>;
  ...
  remove_artwork_from_exhibition?: Maybe<RemoveArtworkFromExhibitionMutationPayload>;
  ...
  remove_person_from_exhibition?: Maybe<RemovePersonFromExhibitionMutationPayload>;
  renew_token?: Maybe<RenewTokenMutationPayload>;
  reorder_artwork?: Maybe<ReorderArtworkMutationPayload>;
  reorder_exhibition_artworks?: Maybe<ReorderExhibitionArtworksMutationPayload>;
  ...
  update_person?: Maybe<UpdatePersonMutationPayload>;
  update_tag?: Maybe<UpdateTagMutationPayload>;
};


export type MutationAbort_Multipart_UploadArgs = {
  input: AbortMultipartUploadMutationInput;
};
...
export type MutationAdd_Artwork_To_ExhibitionArgs = {
  input: AddArtworkToExhibitionMutationInput;
};
...
export type MutationAdd_PersonArgs = {
  input: AddPersonMutationInput;
};


export type MutationAdd_Person_To_ExhibitionArgs = {
  input: AddPersonToExhibitionMutationInput;
};
...
export type MutationComplete_Multipart_UploadArgs = {
  input: CompleteMultipartUploadMutationInput;
};


export type MutationCreate_Multipart_UploadArgs = {
  input: CreateMultipartUploadMutationInput;
};
...
export type MutationRemove_Artwork_From_ExhibitionArgs = {
  input: RemoveArtworkFromExhibitionMutationInput;
};
...
export type MutationRemove_Person_From_ExhibitionArgs = {
  input: RemovePersonFromExhibitionMutationInput;
};
...
export type MutationReorder_Exhibition_ArtworksArgs = {
  input: ReorderExhibitionArtworksMutationInput;
};
...
/** A person who can appear as an exhibition artist or curator */
export type Person = {
  __typename?: 'Person';
  created_at: Scalars['String'];
  exhibitions: Array<Exhibition>;
...
/** A person who can appear as an exhibition artist or curator */
export type PersonCreated_AtArgs = {
  format?: InputMaybe<Scalars['String']>;
  relative?: InputMaybe<Scalars['Boolean']>;
};
...
/** A person who can appear as an exhibition artist or curator */
export type PersonExhibitionsArgs = {
  kind?: InputMaybe<ExhibitionKind>;
  role?: InputMaybe<ExhibitionRole>;
  state?: InputMaybe<Array<InputMaybe<State>>>;
};


/** A person who can appear as an exhibition artist or curator */
export type PersonUpdated_AtArgs = {
  format?: InputMaybe<Scalars['String']>;
  relative?: InputMaybe<Scalars['Boolean']>;
};
...
/** A presigned single-object PUT. Callers must use unique keys to avoid replacing existing objects. */
export type PreparedUpload = {
  __typename?: 'PreparedUpload';
  expires_at: Scalars['ISO8601DateTime'];
  file_key: Scalars['String'];
  /** Headers that must be sent with the signed request, including Content-Type and any required ACL or Cache-Control headers */
...
export type PresignedUrlAttributes = {
  /** Object key in the configured bucket. Must be unique; uploading to an existing key replaces the object. */
  file_key: Scalars['String'];
  file_type: Scalars['String'];
};
...
/** A production file for an artwork */
export type ProductionFile = {
  __typename?: 'ProductionFile';
  description?: Maybe<Scalars['String']>;
  file_content_length?: Maybe<Scalars['BigInt']>;
...
export type ProductionFileAttributes = {
  description?: InputMaybe<Scalars['String']>;
  file_content_length?: InputMaybe<Scalars['BigInt']>;
...
export type Query = {
  ...
  /** A person */
  person: Person;
  /** Presigns PUT uploads to the configured bucket without uploading bytes or creating records. Callers must use unique keys to avoid replacing existing objects. */
  prepare_uploads: Array<PreparedUpload>;
...
/** The query root for this schema */
export type QueryPrepare_UploadsArgs = {
...
/** Autogenerated input type of RemoveArtworkFromExhibitionMutation */
export type RemoveArtworkFromExhibitionMutationInput = {
  artwork_id: Scalars['ID'];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  exhibition_id: Scalars['ID'];
...
/** Autogenerated return type of RemoveArtworkFromExhibitionMutation. */
export type RemoveArtworkFromExhibitionMutationPayload = {
  __typename?: 'RemoveArtworkFromExhibitionMutationPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  exhibition: Exhibition;
};
...
/** Autogenerated input type of RemovePersonFromExhibitionMutation */
export type RemovePersonFromExhibitionMutationInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  exhibition_id: Scalars['ID'];
  person_id: Scalars['ID'];
...
/** Autogenerated return type of RemovePersonFromExhibitionMutation. */
export type RemovePersonFromExhibitionMutationPayload = {
  __typename?: 'RemovePersonFromExhibitionMutationPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  exhibition: Exhibition;
};
...
/** Autogenerated input type of ReorderExhibitionArtworksMutation */
export type ReorderExhibitionArtworksMutationInput = {
  artwork_ids: Array<Scalars['ID']>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  exhibition_id: Scalars['ID'];
};

/** Autogenerated return type of ReorderExhibitionArtworksMutation. */
export type ReorderExhibitionArtworksMutationPayload = {
  __typename?: 'ReorderExhibitionArtworksMutationPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  exhibition: Exhibition;
};
...
export type UpdateArtworkEntityAttributes = {
  ...
  production_file?: InputMaybe<UpdateProductionFileAttributes>;
};
...
export type UpdatePersonAttributes = {
  name?: InputMaybe<Scalars['String']>;
  website_url?: InputMaybe<Scalars['String']>;
};

/** Autogenerated input type of UpdatePersonMutation */
...
/** Autogenerated return type of UpdatePersonMutation. */
...
export type Resources_ArtworkFragment = { __typename?: 'Artwork', productionFiles: Array<{ __typename?: 'ProductionFile', id: string, title: string, description?: string | null, file_content_length?: any | null, url: string }>, sourceLinks: Array<{ __typename?: 'Link', id: string, title: string, description?: string | null, url: string }> };
...
export type ExhibitionsIndexQueryVariables = Exact<{
...
export type ExhibitionsShowQuery = { __typename?: 'Query', exhibition: { __typename?: 'Exhibition', title: string, venue?: string | null, city?: string | null, year?: number | null, start_date?: string | null, end_date?: string | null, external_url?: string | null, description?: string | null, start_year?: string | null, end_year?: string | null, descriptionPlain?: string | null, curators: Array<{ __typename?: 'Person', id: string, name: string, website_url?: string | null }>, artists: Array<{ __typename?: 'Person', id: string, name: string, website_url?: string | null }>, artworks: Array<{ __typename?: 'Artwork', id: string, slug: string, title: string, material?: string | null, year: number, price?: { __typename?: 'Price', amount: string, was?: string | null } | null, images: Array<{ __typename?: 'Image', placeholder: { __typename?: 'ResizedImage', urls: { __typename?: 'RetinaImage', src: string } }, resized: { __typename?: 'ResizedImage', width: number, height: number, urls: { __typename?: 'RetinaImage', _1x: string, _2x: string, _3x: string } } }> }>, images: Array<{ __typename?: 'Image', id: string, width?: number | null, height?: number | null, title?: string | null, description?: string | null, url: string, placeholder: { __typename?: 'ResizedImage', urls: { __typename?: 'RetinaImage', src: string } }, thumb: { __typename?: 'ResizedImage', width: number, height: number, srcs: { __typename?: 'RetinaImage', _1x: string, _2x: string, _3x: string } } }>, metaImages: Array<{ __typename?: 'Image', resized: { __typename?: 'ResizedImage', urls: { __typename?: 'RetinaImage', src: string } } }> } };
...
export const Figure_ImageFragmentDoc = gql`
  ...
  zoom: resized(width: 4000, height: 4000, quality: 60) {
    ...
    `;
export const Resources_ArtworkFragmentDoc = gql`
